...
class predictor(nn.Module):
    ...
    def __init__(self, branch, trunc, super, share, super_order=None):
    ...
    def forward(self, design, coords):
        ...
        for _ in range(hole_num-1):
            ...
            F_input = torch.cat(feature_list[idx:idx+1], axis=0)
        ...
        sdf_all = torch.min(torch.transpose(design, 0, -1), axis=-1)
