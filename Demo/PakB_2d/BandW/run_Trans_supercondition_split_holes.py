...
if __name__ == "__main__":
    ...
    train_loader_0, x_normalizer, y_normalizer = get_loader_from_list_combine(train_input_list,
                                                                   train_output_list,
                                                                   batch_size=batch_size,
                                                                   shuffle=True,
                                                                   channel_num=in_dim,
                                                                   )
    train_loader_1, _, _ = get_loader_from_list_combine(train_input_list,
                                                    train_output_list,
                                                    x_normalizer=x_normalizer,
                                                    y_normalizer=y_normalizer,
                                                    batch_size=batch_size,
                                                    shuffle=True,
                                                    channel_num=in_dim * (2**1),
                                                    )
    valid_loader_0, _, _ = get_loader_from_list_combine(valid_input_list,
                                                    valid_output_list,
                                                    x_normalizer=x_normalizer,
                                                    y_normalizer=y_normalizer,
                                                    batch_size=batch_size,
    ...
    valid_loader_1, _, _ = get_loader_from_list_combine(valid_input_list,
                                                        valid_output_list,
                                                        x_normalizer=x_normalizer,
                                                        y_normalizer=y_normalizer,
                                                        batch_size=batch_size,
