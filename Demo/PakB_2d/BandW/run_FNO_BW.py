...
if __name__ == "__main__":
    ...
    for epoch in range(epochs):
        ...
        Net_model.train()
        log_loss['train_step_loss'].append(train_mask(train_loader, Net_model, Device, Loss_func, Optimizer, Scheduler, x_norm=x_normalizer))
