...
from run_FNO_supercondition import predictor, train_supercondition, valid_supercondition
...
if __name__ == "__main__":
    ...
    wandb.init(
        ...
        entity="turbo-1997",
        notes="const=350, channe_num=8",
        name='supercondition_0_1_without_10',
    ...
    Net_model = predictor(perd_model, super_model, channel_num=channel_num).to(Device)
    # # 损失函数
    ...
    for epoch in range(epochs):
        ...
        log_loss['valid_cross_step_loss'].append(valid(valid_loader_cross, Net_model, Device, Loss_func_valid))
        ...
        if epoch % 10 == 0:
            ...
            valid_source_cross, valid_true_cross, valid_pred_cross = inference(valid_loader_cross, Net_model, Device)
