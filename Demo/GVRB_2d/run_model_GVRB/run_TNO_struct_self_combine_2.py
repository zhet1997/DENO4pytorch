...
import time
import yaml
from Demo.GVRB_2d.utilizes_GVRB import get_origin, SelfSuperviseLoss, SelfSuperviseLoss2, SelfSuperviseLoss3
...
if __name__ == "__main__":
    ...
    name = 'TNO'
    work_path = os.path.join('../work', name + '_' + str(21) + '_self_combine')
