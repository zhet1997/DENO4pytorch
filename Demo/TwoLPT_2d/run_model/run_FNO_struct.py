...
if __name__ == "__main__":
    ...
    work_load_path1 = os.path.join('E:\WQN\CODE\DENO4pytorch\Demo\GVRB_2d\work1\FNO_6')
    ...
    #                 'Relative Total Temperature',
    #                 'Absolute Total Temperature']
    # Visual = MatplotlibVision(work_load_path1, input_name=('x', 'y'), field_name=('ps', 'ts', 'rho', 'vx', 'vy', 'vz', 'tt1', 'tt2'))
