...
from Demo.satellite_sup_2d.trains_satellite import (train_base, valid_base)
...
if __name__ == "__main__":
    ...
    # 数据加载（固定V2/17通道）
    train_loader, valid_loader, x_normalizer, y_normalizer, meta = get_loaders_satellite_GUT(
        train_num=ntrain,
        valid_num=nvalid,
