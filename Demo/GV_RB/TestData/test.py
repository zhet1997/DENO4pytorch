...
def plot_spanwise_distribution(rst_true, rst_pred, num, variable_name, save_name, save_path):
    ...
    ax0 = plt.subplot(111)
    plt.plot(rst_true[num,:], np.linspace(0,1,128), ls='-', lw=1.5, alpha=0.8,
             color='blue', label='CFD')
    plt.scatter(rst_pred[num,:], np.linspace(0,1,128), s=3,
...
def plot_performance_compare(rst_true, rst_pred, variable_name, save_name, save_path):
    ...
    plt.ylabel('Prediction', fontsize=14, fontproperties='Times New Roman')
...
if __name__ == '__main__':
    ...
    #
    #     save_path = "D://WQN//CODE//DENO4pytorch-main//Demo//GV_RB//work_Trans5000_3//Transformer//result_spanwise"
    #     for num in range(10):
    ...
    for variable_name in variable_name_list:
        ...
        save_path = "D://WQN//CODE//DENO4pytorch-main//Demo//GV_RB//work_Trans5000_3//Transformer//result_averaged"
