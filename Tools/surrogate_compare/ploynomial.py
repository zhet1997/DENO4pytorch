...
from Tools.post_process.load_model import get_noise
...
if __name__ == "__main__":
    ...
    np.savez(os.path.join("../../Demo/Rotor37_2d", "data", "surrogate_data", "ploynomial_num.npz"), **dict_num)
    np.savez(os.path.join("../../Demo/Rotor37_2d", "data", "surrogate_data", "ploynomial_noise.npz"), **dict_noise)
