...
if __name__ == "__main__":
    ...
    np.savez(os.path.join("../../Demo/Rotor37_2d", "data", "surrogate_data", "XGB_num.npz"), **dict_num)
    np.savez(os.path.join("../../Demo/Rotor37_2d", "data", "surrogate_data", "XGB_noise.npz"), **dict_noise)
