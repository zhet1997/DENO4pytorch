...
def draw_span_all(post_true, post_pred,
                  work=None, save_path=None, parameterList=None, stage_name='stage',):
    ## draw the figure
...
if __name__ == '__main__':
    ...
    draw_span_all(post_true, post_pred, work=work, save_path=save_path,    parameterList = ['Static_pressure_ratio',
                     'Total_total_efficiency',
                     'Total_static_efficiency',
                     'Degree_reaction',
                     ])
