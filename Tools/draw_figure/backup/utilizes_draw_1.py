...
def a_case():
    work_path = os.path.join("../../../Demo/GVRB_2d", "data_collect")
    isCreated = os.path.exists(work_path)
    if not isCreated: os.mkdir(work_path)

    grid = get_grid(real_path=os.path.join("../../../Demo/GVRB_2d", "data"))
    design, field = get_origin(realpath=os.path.join("../../../Demo/GVRB_2d", "data"),
